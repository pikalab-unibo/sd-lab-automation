...
\frametitle{Gradle I}
    ...
    %
    \begin{itemize}
        \item It assumes an App project to adhere to a well defined \alert{directory structure}

        \vfill

        \item A \alert{\texttt{gradlew}} (or \texttt{gradlew.bat}, on Windows system) script is assumed to be present within the project root directory
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            %
            \begin{itemize}
                \item firstly \alert{assembled} (i.e., compiles)
